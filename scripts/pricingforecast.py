...
def pricingforecast(inputvar):
    ...
    if 'venta' in tiponegocio.lower() or 'sell' in tiponegocio.lower():
        filename = r'D:\Dropbox\Empresa\Buydepa\COLOMBIA\DESARROLLO\proyecto-opensource-buydepa\data\ANN_bogota_venta_apartamento'
    if 'arriendo' in tiponegocio.lower() or 'rent' in tiponegocio.lower():
        filename = r'D:\Dropbox\Empresa\Buydepa\COLOMBIA\DESARROLLO\proyecto-opensource-buydepa\data\ANN_bogota_arriendo_apartamento'
